...
none_urls = []
bad_urls = []
base_url = "https://mobiletest.drivetime.com"

start_time = datetime.datetime.now()

main_sitemap = requests.get(base_url + "/sitemap/make-model.xml")
...
rs = (grequests.get(link, timeout=5) for link in main_links)
...
# if none_urls:
# 	 for url in bad_urls: 
# 		print emoji.emojize('You might want to double check these: {0}'.format(url))
